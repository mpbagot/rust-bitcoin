...
mod const_casts {
    /// Converts `u16` to `u64`
    #[must_use]
    pub(super) const fn u16_to_u64(value: u16) -> u64 { value as u64 }

    /// Converts `u32` to `u64`
    #[must_use]
    pub(super) const fn u32_to_u64(value: u32) -> u64 { value as u64 }

    /// Converts `i16` to `i64`
    #[must_use]
    pub(super) const fn i16_to_i64(value: i16) -> i64 { value as i64 }

    /// Converts `u16` to `u32`
    #[must_use]
    pub(super) const fn u16_to_u32(value: u16) -> u32 { value as u32 }
}
